...
#     def __init__(self, my_rooster, g=1.002, initial_T=50, final_T=20):
#         self.g = g
...
#                             self.swap_course(room1, lecture2, slot1, room2, lecture1, slot2)
#
#                         elif random.uniform(0, 1) < round(math.exp((new - old) / self.current_T), 10):
#                             self.swap_course(room1, lecture2, slot1, room2, lecture1, slot2)
#
#                         else:
#                             room1 = room2
...
# annealing = Simulated_Annealing(my_rooster).run()

...
class Hillclimber():
    ...
    # def hc_students(self, tut_or_prac): # NEW VERSION
    #     '''
    ...
    #     '''
    #     Accepts two students, their current activities and slots. If student is
    #     not 0, student is removed from their activity and added to the other
    #     activity. Also updates the student roosters and the malus points.
    #     '''
    #     if student1 != 0:
    #         act1.studs.remove(student1)
    #         act1.size -= 1
    ...
    # def create_stud_set(self, stud_list, add_zero=True): # NEW VERSION
    #     '''
    ...
    # def try_swap(self, student, group, new_group, new_group_nr, tries_dict, add_zero=True): # NEW VERSION
    #     '''
